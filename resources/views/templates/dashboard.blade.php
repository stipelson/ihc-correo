  ...
  <div class="navbar-fixed">
   ...
   <ul id="slide-out" class="side-nav">
    <ul class="collapsible" data-collapsible="accordion">
      ...
      <li>
        <div class="collapsible-header black-text"><i class="fa fa-users" aria-hidden="true"></i>Usuarios<i class="right fa fa-chevron-right" aria-hidden="true"></i>
        </div>
     ...
     @else
     <li>
       <a class="collapsible-header black-text" href="{{ route('user.show', Auth::user()->id) }}"><i class="fa fa-fw fa-user"></i> Perfil</a>
     </li>
     <li>

      <a class="collapsible-header black-text"  href="{{ route('logout') }}">
